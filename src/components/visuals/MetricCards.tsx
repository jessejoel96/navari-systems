...
const metrics = [
  {
    metric: "18 hrs",
    label: "per week",
    desc: "Real Estate Agency - UK · Listing sync automation across all platforms.",
    fill: 90,
    color: "#c9a84c",
  },
  {
    metric: "$2,100",
    label: "per month",
    desc: "Online Education - UK · Onboarding and certificate delivery automation.",
    fill: 85,
    color: "#4AC98A",
  },
  {
    ...
    desc: "Professional Services - UK · Lead qualification and routing automation.",
    fill: 94,
    color: "#c9a84c",
  },
];
